...
# ============================================
# BOT1_TOKEN: Token from @BotFather for Bot 1
# BOT2_TOKEN: Token from @BotFather for Bot 2
# GROUP_ID: Your Telegram Group ID (e.g., -1001234567890)
...
if not BOT1_TOKEN or not BOT2_TOKEN or not GROUP_ID:
    ...
    print("Please set BOT1_TOKEN, BOT2_TOKEN, and GROUP_ID in Render dashboard.")
    exit(1)

# ============================================
# MESSAGE RANGES - 34.6 Million Total
...
# ============================================
# PROGRESS TRACKING
# Saves progress to JSON file so bot can resume after restart
# ============================================
...
# Deletes up to 100 messages per API call
# ============================================
...
def run_bot(token, start_id, end_id, bot_name):
    ...
    for i in range(current, end_id + 1, 100):
        ...
        # Safe delay: 1s + random 0.5-1.5s = ~1.5-2.5s per call
...
if __name__ == "__main__":
    ...
    t1 = threading.Thread(target=run_bot, args=(BOT1_TOKEN, BOT1_START, BOT1_END, "Bot1"))
    t2 = threading.Thread(target=run_bot, args=(BOT2_TOKEN, BOT2_START, BOT2_END, "Bot2"))
